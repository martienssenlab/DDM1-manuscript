...
usage="
##### Script for Histone ChIP data analysis
#####
##### ChIP_secondary.sh -f samplefile [-h]
...
do
	...
	qsub -N ${name} -V -cwd -sync y -pe threads 2 -l m_mem_free=2G -l tmp_free=50G -j y -o logs/analysis_${name}.log <<-'EOF1' &
		...
		case "${mark}" in
			H3K4me1|H3K27me1|H3K27me2|H3K27me3|H3K9me1|H3K9me2|H3K9me3|H4K20me1|H4K20me2|H4K20me3|*DDM1|H3.3|H3.1|MGH3) export peaktype="broad";;
